      ...
      <div className="mt-8 max-w-6xl mx-auto">
        <div className="relative">
          ...
          <div className="relative bg-white/80 backdrop-blur-2xl p-8 rounded-3xl border border-gray-200/60 shadow-2xl">
            ...
            <div className="mb-8">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-50/60 to-white/40 rounded-2xl"></div>
                <div className="relative bg-white/60 backdrop-blur-sm p-6 rounded-2xl border border-blue-200/50">
                  <label htmlFor="wine" className="block text-sm font-medium text-gray-700 mb-3">
                    Vyberte víno ze seznamu
                  </label>
                  <select
                    id="wine"
                    name="wine"
                    ...
                    className="w-full px-4 py-3 bg-white/80 backdrop-blur-sm border border-gray-200/60 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500/50 transition-all duration-300 text-gray-900"
                  >
            ...
            {loading && (
              <div className="flex justify-center py-12">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-lg font-medium text-gray-700">Generuji QR kód...</span>
                </div>
              </div>
            )}
