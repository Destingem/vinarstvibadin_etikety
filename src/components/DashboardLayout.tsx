...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  // No useEffect needed - auth is handled by the AuthContext
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="lg:hidden">
        <div className="fixed inset-0 flex z-40 lg:hidden" role="dialog" aria-modal="true">
          ...
          {/* Off-canvas menu */}
          <div className={`relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white transition-transform transform ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
