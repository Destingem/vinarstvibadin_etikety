...
interface QRCodeGeneratorProps {
  ...
  onQRCodeGenerated: (qrCodeDataUrl: string, options: any) => void;
}

/**
 * Enhanced QR code generator with logo embedding
 ...
 */
export default function QRCodeCustomizerNew({
  wineId,
  token,
  width,
  margin,
  ...
  return (
    <div>
      ...
      >
        {isGenerating ? "Generuji..." : "Generovat QR kód s logem"}
      </button>
